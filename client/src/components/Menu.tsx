    ...
    return(
        <div className="py-8 grid grid-cols-1 text-center md:grid-cols-2 my-12" style={bgWoodImage}>
            ...
            <div className="p-4 relative">
                ...
                <BannerHeader left="50%" top="1rem"  width="255" height="400" viewBox="0 0 155 76"/>
            ...
            <div className="p-4 relative">
                ...
                <BannerHeader left="50%" top="1rem"  width="255" height="124" viewBox="0 0 155 76"/>
            ...
            <div className="p-4 relative">
                ...
                <BannerHeader  top="1rem"  width="255" height="124" viewBox="0 0 155 76"/>
                <ul>
